...
Respuestas = ("2;3;10;2;7;3;2000;","2;1;11;1;;;2000;","0;","2;2;10,11;2;;;5000;","2;15;41;5;;;1500;","2;0;41;6;;;0;","2;2;10;3;;;2000;")

def iniciarPilaDePublicacionMQTT():
    """!
    @brief Función que inicia un bucle permanente para procesar la pila de mensajes MQTT pendientes de publicación
    """
    while True:
...
def cargarPublicacionesMQTT(listaPublicaciones):
    """!
    @brief Función que anexa a la pila actual de mensajes MQTT, los mensajes pasados por parámetro
    @param listaPublicaciones Lista de mensajes MQTT a añadir a la pila del sistema
    """
    global_vars.pilaPublicacionesMQTT.extend(listaPublicaciones)

def publicarMQTT(topic,mensaje,plantilla):
    """!
    @brief Función que libera un hilo para publicar un mensaje MQTT
    @param topic Topic del mensaje MQTT
    @param mensaje Contenido del mensaje MQTT
    @param plantilla Índice de plantilla para el mensaje MQTT
    """
...
def publicarMensaje(topic,mensaje,plantilla):
    """!
    @brief Función que publica un mensaje MQTT
    @param topic Topic del mensaje MQTT
    @param mensaje Contenido del mensaje MQTT
    @param plantilla Índice de plantilla para el mensaje MQTT
    """
...
def encenderAvisoMQTT():
    """!
    @brief Función que enciende el aviso de lectura RFID al dispositivo inalámbrico
    """
...
def apagarAvisoMQTT():
    """!
    @brief Función que apaga el aviso de lectura RFID al dispositivo inalámbrico
    """
